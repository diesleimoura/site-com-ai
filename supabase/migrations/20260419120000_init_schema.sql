...
create policy "sites_all_own" on public.sites for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
...
create policy "proposals_all_own" on public.proposals for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
...
create policy "subs_all_own" on public.subscriptions for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
...
create policy "wallet_all_own" on public.wallet_transactions for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
...
create policy "withdrawals_all_own" on public.withdrawals for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
...
create policy "prospect_all_own" on public.prospect_searches for all using (auth.uid() = tenant_id) with check (auth.uid() = tenant_id);
